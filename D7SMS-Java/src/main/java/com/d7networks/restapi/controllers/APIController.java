...
public class APIController extends BaseController {
    ...
    public void getBalance(
        ...
        HttpRequest _request = _buildGetBalanceRequest();
    ...
    public void createSendSMS(
        ...
        HttpRequest _request = _buildCreateSendSMSRequest(input);
        HttpResponse _response = getClientInstance().executeAsString(_request);
        HttpContext _context = new HttpContext(_request, _response);
     ...
     * @return    Returns the void response from the API call 
     */
    public void createBulkSMS(
                final BulkSMSRequest body,
                final String contentType,
                final String accept
    ) throws Throwable {

        HttpRequest _request = _buildCreateBulkSMSRequest(body, contentType, accept);
        HttpResponse _response = getClientInstance().executeAsString(_request);
        HttpContext _context = new HttpContext(_request, _response);
